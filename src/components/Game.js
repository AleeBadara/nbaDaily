        ...
        if (st.toString() === "1") {
            ...
            return (
                <div >
                    ...
                    <button className="btn btn-sm btn-outline-info disabled pimpmy_gamebtn"><i className="fa fa-youtube-play" aria-hidden="true"></i></button>
                    <NavLink to={`comments/${date}/${props.gid}/${st}/${vAbreviation}/${hAbreviation}`}><button className="btn btn-sm btn-outline-info pimpmy_gamebtn"><i className="fa fa-commenting-o" aria-hidden="true"></i></button></NavLink>
                </div>
            )
            ...
            return (
                <div>
                    ...
                    <NavLink to={`comments/${date}/${props.gid}/${st}/${vAbreviation}/${hAbreviation}`}><button className="btn btn-sm btn-outline-info pimpmy_gamebtn"><i className="fa fa-comment-o" aria-hidden="true"></i></button></NavLink>
                </div>
            )
